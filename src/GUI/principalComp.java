...
public class principalComp extends JFrame{
    public static void main(){
       ...
       /* for (int i = 1; i <= 6; i++) {
            JLabel labellb = new JLabel("Label " + i, SwingConstants.CENTER);
            labellb.setOpaque(true);
            labellb.setBackground(Color.YELLOW);
            labellb.setBorder(BorderFactory.createLineBorder(Color.BLACK));
            labl_panel.add(labellb);
        }*/
